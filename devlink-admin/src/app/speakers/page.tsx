...
export default function SpeakersPage() {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-text-primary">Speakers</h1>
        <p className="text-text-muted mt-1">Maintain a database of past and upcoming guest speakers.</p>
      </div>
