...
// For testing: use Mailtrap (https://mailtrap.io) — no real emails sent
...
export async function sendHackathonInvite({
  toEmail,
  teamName,
  leaderName,
  confirmToken,
      ...
      <body>
        <div class="wrapper">
          ...
          <div class="body">
            ...
            <p style="margin-top: 24px; font-size: 13px;">Or copy this link into your browser:<br/><span style="color:#a78bfa; word-break:break-all;">${confirmUrl}</span></p>
          </div>
          <div class="footer">
