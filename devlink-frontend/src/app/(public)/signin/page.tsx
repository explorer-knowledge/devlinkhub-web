...
export default function LoginPage() {
  ...
  // Fake telemetry feed for atmosphere
        ...
        >
          <motion.div variants={fadeUp} className="mb-0">
            <div className="flex items-center gap-4 mb-2">
              ...
              <h1 className="text-3xl sm:text-4xl font-extrabold text-white tracking-tight">Access Node</h1>
            </div>
          ...
          {error && (
            <motion.div
              ...
              className="mt-6 px-4 py-3 rounded-xl bg-red-500/10 border border-red-500/20 text-red-400 text-sm"
            >
              {error}
            </motion.div>
          )}
          ...
          {/* Email / Password Form */}
          <motion.form variants={fadeUp} onSubmit={handleEmailSignIn} className="space-y-5 mt-8">
          ...
          <motion.div variants={fadeUp} className="grid grid-cols-2 gap-3">
            <button
              ...
              className="h-12 flex items-center justify-center gap-2 bg-white/[0.03] hover:bg-white/[0.08] text-white font-medium rounded-xl border border-white/10 transition-all active:scale-[0.98]"
            >
