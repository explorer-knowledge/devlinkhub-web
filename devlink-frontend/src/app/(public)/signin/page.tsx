  ...
  return (
    <div className="min-h-screen bg-[#030303] text-zinc-100 font-sans selection:bg-[#00F0FF]/30 flex flex-col md:flex-row overflow-hidden">
      ...
      <div className="w-full md:w-1/2 flex flex-col items-center justify-center relative min-h-screen p-6 sm:p-12 z-10">
        ...
        >
          {/* Back button (Desktop) */}
          <motion.div variants={fadeUp} className="hidden md:block mb-10">
          ...
          <motion.div variants={fadeUp} className="mb-8">
            <div className="w-12 h-12 rounded-xl bg-white/[0.03] border border-white/10 flex items-center justify-center mb-6 shadow-inner">
              <Fingerprint size={20} className="text-[#00F0FF]" />
            </div>
          ...
          <motion.div variants={fadeUp} className="space-y-4 mb-8">
            <button className="w-full h-12 flex items-center justify-center gap-3 bg-white text-black font-bold rounded-xl hover:scale-[1.02] active:scale-[0.98] transition-all shadow-[0_0_20px_rgba(255,255,255,0.1)]">
              <Github size={20} />
              Continue with GitHub
            </button>
            <button className="w-full h-12 flex items-center justify-center gap-3 bg-white/[0.03] hover:bg-white/[0.08] text-white font-medium rounded-xl border border-white/10 transition-all active:scale-[0.98]">
          ...
          <motion.div variants={fadeUp} className="flex items-center gap-4 mb-8">
            ...
            <span className="text-[11px] font-mono text-zinc-600 uppercase tracking-widest">Or authenticate via email</span>
            <div className="h-px bg-white/10 flex-1" />
          </motion.div>
          ...
          <motion.div variants={fadeUp} className="mt-8 pt-8 border-t border-white/5 text-center text-sm text-zinc-400">
            Need a node?{" "}
            <Link href="/join" className="text-white font-bold hover:text-[#00F0FF] transition-colors">
              Join DevLink
            </Link>
          </motion.div>
