  ...
  return (
    <div className="min-h-screen bg-[#000000] text-zinc-300 font-sans selection:bg-[#FF1CF7]/30 overflow-hidden flex flex-col">
      ...
      <main className="flex-1 relative z-10 w-full max-w-[1200px] mx-auto px-6 pt-32 pb-32">
        ...
        {/* ─── 1. HERO SECTION ─── */}
        <section className="text-center pb-20 border-b border-white/5">
          <motion.div initial="hidden" animate="visible" variants={stagger} className="max-w-3xl mx-auto flex flex-col items-center">
            <motion.div variants={fadeUp} className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/5 border border-white/10 text-[10px] font-bold tracking-widest uppercase text-[#FF1CF7] shadow-[0_0_15px_rgba(255,28,247,0.15)] backdrop-blur-md mb-6">
              <Zap size={12} className="text-[#FF1CF7]" />
              DevLink Live
            </motion.div>

            <motion.h1 variants={fadeUp} className="text-5xl sm:text-6xl lg:text-7xl font-black text-white tracking-tighter leading-[1.05] mb-6">
              Global Sprints &<br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#FF1CF7] to-[#7B61FF]">Ecosystem Events.</span>
            </motion.h1>

            <motion.p variants={fadeUp} className="text-base text-zinc-400 font-light leading-relaxed max-w-xl mb-10">
              Code, collaborate, and compete. Join global hackathons, open-source contribution nights, and founder pitch sessions.
            </motion.p>
          </motion.div>
        </section>
